...
ThemeData violet = ThemeData(
    colorScheme: ColorScheme.dark(
      ...
      tertiary: Color.fromRGBO(85, 81, 132, 1),
      inversePrimary: Color.fromRGBO(254, 233, 206, 1),
    )
);
...
ThemeData purple = ThemeData(
    colorScheme: ColorScheme.dark(
      ...
      tertiary: Color.fromRGBO(75, 33, 56, 1),
      inversePrimary: Color.fromRGBO(250, 220, 213, 1),
    )
);
...
ThemeData blue = ThemeData(
    colorScheme: ColorScheme.dark(
      ...
      tertiary: Color.fromRGBO(5, 38, 89, 1),
      inversePrimary: Color.fromRGBO(193, 232, 255, 1),
    )
);
...
ThemeData golden = ThemeData(
    colorScheme: ColorScheme.dark(
      ...
      tertiary: Color.fromRGBO(41, 44, 53, 1),
      inversePrimary: Color.fromRGBO(252, 217, 184, 1),
    )
);
...
ThemeData bandw = ThemeData(
    colorScheme: ColorScheme.dark(
      ...
      tertiary: Color.fromRGBO(230, 230, 233, 1),
      inversePrimary: Color.fromRGBO(244, 244, 246, 1),
    )
);
